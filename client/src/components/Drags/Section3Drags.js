    ...
    <div className='data-sec3-drags'>
        {
            ...
            product.map((e,idx)=>(
                (e.productCategory === 'pharmacy' && (
                    ( idx <= 8 &&   <div className='product-sec3-drags'key={idx} >
        ...
        { x  ?(  
          ...
          product.map((o,idx)=>(
              (o.productCategory === 'pharmacy' && (
                  ( idx >= 8 && (idx <= 15 &&  <div className='product-sec3-drags'key={idx} >
              <div className='images'>
           ...
           :  undefined}
           {
            product.map((o,idx)=>(
              (o.productCategory === 'pharmacy' && (
                  ( idx >= 50 && (idx <= 60 &&  <div className='product-sec3-drags'key={idx} >
              <div className='images'>
              <img src={o.imagemean} alt=''/></div>
              <h4> {o.productName}</h4>
              <h3> { "EGP " + o.productPrice} </h3>
